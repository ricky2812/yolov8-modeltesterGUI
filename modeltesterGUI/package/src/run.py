...
weight = os.path.join(path,'weights','detection.pt')
light = os.path.join(path,'assets','yolov8.jpeg')
dark = os.path.join(path,'assets','yolov8.jpeg')
icon = os.path.join(path,'assets','icon.ico')
